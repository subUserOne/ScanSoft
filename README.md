...
Сканер штрихкодов, распознание, создание номенклатуры, интеграция с вашим 1С решением.
...
В карточке номенклатуры можно ввести данные по товару, сделать и прикрепить фотографию.<br><br>
  <img src="img/Screenshot_20240112-181207.png" width=30%> <br><br>
